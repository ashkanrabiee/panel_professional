            ...
            <div class="intro-y box p-5">
                <form action="{{ route('admin.content.banner.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" value="{{ old('title') }}" class="input w-full border mt-2 p-2" placeholder="عنوان بنر را وارد کنید">
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="url" value="{{ old('url') }}" class="w-full border mt-2 p-2">
                        @error('url')
                            <span class="text-red-600 text-sm">{{ $message }}</span>
                        @enderror
                    </div>

        ...
        <div class="intro-y col-span-12">
            ...
            <div class="intro-y box p-5">
                <form action="{{ route('admin.content.faq.update',$faq->id) }}" method="POST" id="form">
                    ...
                    <div>
                        <label> پرسش </label>
                        <input type="text" class="input w-full border mt-2" name="question" value="{{ old('question', $faq->question ?? '') }}">
                    </div>
                    <br>
                    <div>
                    ...
                    <div>
                        ...
                        <select id="select_tags" class="select2 w-full border mt-2" multiple>
                            <!-- تگ‌ها در اینجا وارد می‌شوند -->
                        </select>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-2">
                            ...
                            <input type="checkbox" name="status" value="1" class="input input--switch border" {{ old('status', $faq->status ?? 0) == 1 ? 'checked' : '' }}>
                        </div>
                    </div>

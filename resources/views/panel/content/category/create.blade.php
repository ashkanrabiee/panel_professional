        ...
        <div class="intro-y col-span-12">
            ...
            <div class="intro-y box p-5">
                ...
                <div>
                    ...
                    <input type="text" name="name" class="input w-full border mt-2" placeholder="نام" required>
                </div>
                <div class="mt-3">
                    <label>توضیحات دسته بندی</label>
                    <div class="mt-2">
                        <textarea data-feature="basic" id="body" name="description" required></textarea>
                    </div>
                </div>
                <div class="mt-3">

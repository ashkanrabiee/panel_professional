        ...
        <table class="table table-report -mt-2">
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    ...
                    <td>
                        <a href="" class="font-medium whitespace-no-wrap">{{$cat->name}}</a> 
                        
                    </td>
                    <td class="text-center"><input data-target="#programmatically-show-hide-modal" class="show-code input input--switch border" @if ($cat->status == 1)
                        checked
                    @endif type="checkbox"></td>
                    <td class="w-40">
                        <img src="{{ asset($cat->image) }}" alt="بنر" width="100" height="50">
                    </td>
                    <td class="w-40">
                        <p>
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3" href="{{ route('admin.content.category.edit',$cat->id) }}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                            <form class="d-inline" action="{{ route('admin.content.category.destroy', $cat->id) }}" method="post">
                                @csrf
                                @method('DELETE')

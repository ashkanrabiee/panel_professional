...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
        <button class="button text-white bg-theme-1 shadow-md mr-2"><a href="{{ route('admin.market.delivery.create') }}">ایجاد روش ارسال</a></button>
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    <th class="whitespace-no-wrap">نام روش ارسال</th>
                    <th class="whitespace-no-wrap">هزینه ارسال</th>
                    <th class="text-center whitespace-no-wrap">زمان ارسال</th>
                 ...
                 {{$method->name}}
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3" href="{{ route('admin.market.delivery.edit',$method) }}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Edit </a>

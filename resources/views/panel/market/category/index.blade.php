        ...
        <table class="table table-report -mt-2 w-full border border-gray-300">
            <thead class="bg-gray-100 text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-2 border border-gray-300">نام دسته بندی</th>
            ...
            <tbody>
                @foreach ($productCategories as $productCategory)
                    <tr class="intro-x bg-white hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-2 border border-gray-300">{{ $productCategory->name }}</td>
                        <td class="px-4 py-2 border border-gray-300">
                            {{ $productCategory->parent_id ? optional($productCategory->parent)->name : 'دسته اصلی' }}
                        </td>

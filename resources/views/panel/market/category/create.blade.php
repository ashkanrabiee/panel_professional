            ...
            <div class="intro-y box p-5">
                <form action="{{ route('admin.market.category.store') }}" method="post" enctype="multipart/form-data" id="form">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="input w-full border mt-2" placeholder="نام" required>
                    </div>

                    <!-- توضیحات دسته بندی -->
                    <div class="mb-4">
                        <label for="description">توضیحات دسته بندی</label>
                        <textarea name="description" id="description" class="input w-full border mt-2" required>{{ old('description') }}</textarea>
                    </div>

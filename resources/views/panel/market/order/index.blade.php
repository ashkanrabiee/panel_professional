...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center mt-2">
        <button class="button text-white bg-theme-1 shadow-md mr-2"><a href="{{ route('admin.market.category.create') }}">ایجاد دسته بندی</a></button>
        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-no-wrap">نام محصول</th>
                    <th class="text-center whitespace-no-wrap">تاریخ</th>

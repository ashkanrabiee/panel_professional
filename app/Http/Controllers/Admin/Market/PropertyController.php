...
class PropertyController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('panel.market.property.index', compact('category_attributes'));
    }
    ...
    public function create()
    {
        ...
        return view('panel.market.property.create', compact('productCategories'));
    }
    ...
    {
        $productCategories = ProductCategory::all();
        return view('panel.market.property.edit', compact('categoryAttribute', 'productCategories'));
    }
